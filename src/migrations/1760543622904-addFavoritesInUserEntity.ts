...
export class AddFavoritesInUserEntity1760543622904 implements MigrationInterface {
    name = 'AddFavoritesInUserEntity1760543622904'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users_favorites_article" ("usersId" uuid NOT NULL, "articleId" uuid NOT NULL, CONSTRAINT "PK_4019a5dbf3a72da361786c8cfc2" PRIMARY KEY ("usersId", "articleId"))`);
